...
% Dette er ikke helt riktig. Omformuler.

The adversary is able to obtain any session key from a session whose identifier differs from the current session's. 
...
role V{
	...
	recv_1(U, V, Ru);
	claim_V6(V, Running, U, Ru); # Claim that V is currently running the protocol with U
