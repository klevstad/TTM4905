...
%Over the years, multiple intruder models have evolved from the Doley-Yao model. 

%???

%Can be divided into two categories. Model checking and theorem proving. \cite{Boyd2003}
